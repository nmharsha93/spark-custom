...
trait Impurity extends Serializable {
  ...
  var params:mutable.Map[String,String]  = mutable.Map[String,String]()

  def setParams(customParams:mutable.Map[String,String]) = {
    params = customParams
  }
...
private[spark] object ImpurityCalculator {
  ...
  def getCalculator(impurity: String, stats: Array[Double]): ImpurityCalculator = {
    impurity match {
      ...
      case "custom_impurity" => new CustomImpurityCalculator(stats)
      case "sawtooth_impurity" => new SawToothImpurityCalculator(stats)
      case _ =>

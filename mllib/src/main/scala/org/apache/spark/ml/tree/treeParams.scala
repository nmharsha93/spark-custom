...
import org.apache.spark.mllib.tree.impurity.{Entropy => OldEntropy, Gini => OldGini, Impurity => OldImpurity, Variance => OldVariance,CustomImpurity => OldCustomImpurity,SawToothImpurity => OldSawToothImpurity}
...
private[ml] trait TreeClassifierParams extends Params {
  ...
  private[ml] def getOldImpurity: OldImpurity = {
    getImpurity match {
      ...
      case "gini" => OldGini
      case "custom_impurity" => OldCustomImpurity
      case "sawtooth_impurity" => OldSawToothImpurity
      case _ =>
...
private[ml] object TreeClassifierParams {
  ...
  final val supportedImpurities: Array[String] = Array("entropy", "gini","custom_impurity","sawtooth_impurity").map(_.toLowerCase)
}
